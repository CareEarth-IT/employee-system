...
/**
 * Grant real_estate_app access to real_estate DB via Cloud SQL unix socket.
 * Run from Cloud Run job only (deploy/grant-real-estate-app-prod.ps1).
 */
...
try {
    ...
    if ($hosts === []) {
        throw new RuntimeException('real_estate_app not found in mysql.user');
    }
