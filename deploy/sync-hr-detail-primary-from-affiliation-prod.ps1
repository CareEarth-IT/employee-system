...
#   deploy\sync-hr-detail-primary-from-affiliation-prod.cmd
#
...
$JobName = "employee-sync-hr-detail-primary-from-affiliation"
...
$artisanArgs = @("artisan", "employee:sync-hr-detail-primary-from-affiliation")
if ($DryRun) {
    $artisanArgs += "--dry-run"
}
